...
export const furnitureCatalog = [
    {
        ...
        type: 'sofa',
        category: 'seating',
        dimensions: { width: 2.5, height: 0.9, depth: 1.0 },
        color: '#4a5568',
    ...
    },
    {
        ...
        type: 'chair',
        category: 'seating',
        dimensions: { width: 0.65, height: 0.85, depth: 0.65 },
        color: '#2F4F4F',
    ...
    // BEDROOM FURNITURE (4 items)
    {
        ...
        type: 'bed',
        category: 'bedroom',
        dimensions: { width: 2.2, height: 0.7, depth: 2.4 },
        color: '#8B4513',
    ...
    },
    {
        ...
        type: 'bed',
        category: 'bedroom',
        dimensions: { width: 2.0, height: 0.6, depth: 2.0 },
        color: '#8B4513',
    ...
    },
    {
        ...
        type: 'lighting',
        category: 'lighting',
        dimensions: { width: 0.5, height: 1.6, depth: 0.5 },
        color: '#2F4F4F',
    ...
    },
    {
        ...
        type: 'lighting',
        category: 'lighting',
        dimensions: { width: 0.4, height: 2.0, depth: 0.4 },
        color: '#696969',
